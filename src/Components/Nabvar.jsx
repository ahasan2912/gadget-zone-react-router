                ...
                pathname == '/' ?
                    <div className={`navbar bg-[#9538E2] rounded-t-xl `}>
                        <div className="navbar-start">
                            ...
                            <Link to='/' className="btn btn-ghost text-xl text-white">Gadget Zone</Link>
                        </div>
                        ...
                        <div className="navbar-end space-x-1 sm:space-x-4">
                            <div className="bg-white p-2 rounded-full flex items-center relative"><FaCartArrowDown size={18} /><span className="absolute -top-3 right-0 font-semibold text-[#272525] text-lg">{products.length}</span> </div>
                            <div className="bg-white p-2 rounded-full relative"><GiSelfLove size={18} /><span className="absolute -top-3 -right-1 font-semibold text-[#272525] text-lg">{wihsList.length}</span></div>
                        </div>
                    </div>
                    :
                    <div className={`navbar rounded-t-lg `}>
                        <div className="navbar-start">
                            ...
                            <Link to='/' className="btn btn-ghost text-xl text-black">Gadget Zone</Link>
                        </div>
                        <div className="navbar-center hidden lg:flex">
                            <ul className={`menu menu-horizontal px-1 space-x-10 text-white text-base`}>
                                <NavLink
                        ...
                        <div className="navbar-end space-x-1 sm:space-x-4">
                            <div className="bg-gray-300 p-2 rounded-full relative"><FaCartArrowDown size={18} /><span className="absolute -top-4 -right-1 font-semibold text-black text-lg">{products.length}</span> </div>
                            <div className="bg-gray-300 p-2 rounded-full relative"><GiSelfLove size={18} /><span className="absolute -top-4 -right-1 font-semibold text-black text-lg">{wihsList.length}</span> </div>
                        </div>
                    </div>
            }
        </div>
