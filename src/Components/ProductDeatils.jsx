    ...
    return (
        <div className="flex flex-col pb-20 md:pb-[250px]">
            <div className="bg-[#9538E2] py-10 md:pb-[250px] md:relative">
                ...
                <div className="w-full md:w-[768px] mx-auto flex flex-col sm:flex-row border-2 bg-white px-6 py-4 rounded-lg md:absolute top-[400px] left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 mt-10 sm:mt-0">
                    ...
                    <div>
                        ...
                        <button className="px-3 border bg-green-300 rounded-full">{availability}</button>
                        <p>{description}</p>
                        <h3>Sepcification: </h3>
                        <div>
                        ...
                        <div className="rating">
                            ...
                            <input type="radio" name="rating-3" className="mask mask-star-2 bg-orange-400" />
                            <input type="radio" name="rating-3" className="mask mask-star-2 bg-orange-400" />
                            <input type="radio" name="rating-3" className="mask mask-star-2 bg-orange-300" />
                            <input type="radio" name="rating-3" className="mask mask-star-2 bg-orange-200" />
                        </div>
                        <div className="flex items-center gap-3">
                            <button onClick={()=> handleAddItem(product)} className="btn btn-outline bg-[#9538E2] text-white">Add To Card</button>
                            <div onClick={()=> handleWishItem(product)} className="btn btn-outline bg-[#9538E2] text-white rounded-full"><GiSelfLove size={20} /></div>
                        </div>
                    </div>
                </div>
            </div>
