        ...
        <div>
            <div className="bg-[#9538E2] pt-5 pb-20 ">
                ...
                <div className="flex items-center justify-center gap-3 mt-3">
                    <button onClick={() => handleBtnType('cart')} className={`btn px-7 text-base ${checkBtn ? 'btn-warning' : ''}`}>Cart</button>
                    <button onClick={() => handleBtnType('wish')} className={`btn px-7 text-base ${checkBtn ? '' : 'btn-warning'}`}>Wishlist</button>
                </div>
            </div>
            <div className="max-w-5xl mx-auto">
                <div className='flex flex-col sm:flex-row items-center justify-between my-4 '>
                    ...
                    <div className='flex flex-col sm:flex-row sm:items-center gap-4'>
                        ...
                        <button onClick={handleSort} className='btn text-base bg-[#9538E2] hover:bg-[#483458] text-white'>Sort by Price</button>
                        <button onClick={handlePurchase} className='btn text-base bg-[#9538E2] hover:bg-[#483458] text-white'>Purchase</button>
                    </div>
                </div>
                {
            ...
            <dialog id="customModal" className="modal">
                <div className="modal-box flex flex-col items-center justify-center gap-2">
                    ...
                    <div className="modal-action">
                        <form method="dialog">
                            <button onClick={(()=> handleCloseBtn())} className='btn text-base bg-[#9538E2] hover:bg-[#483458] text-white'>Close</button>
                        </form>
                    </div>
                </div>
            </dialog>
